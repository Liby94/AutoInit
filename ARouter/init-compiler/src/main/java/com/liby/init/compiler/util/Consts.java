 ...
 */
public class Consts {
    // AutoInit service start
    public static final String AUTO_INIT_SERVICE = "com.liby.init.api.AutoInitService";
    // AutoInit service end


    // Generate
    public static final String SEPARATOR = "$$";
    public static final String PROJECT = "AutoInit";
