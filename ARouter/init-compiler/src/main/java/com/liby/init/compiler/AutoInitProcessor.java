...
//                        String groupFile = "AutoInit$" + simpleName;
//                        JavaFile javaFile = JavaFile.builder("com.liby.autoinit",
//                                TypeSpec.classBuilder(groupFile)
//                                        .addJavadoc("DO NOT EDIT THIS FILE!!! IT WAS GENERATED BY AutoInit.")
//                                        .addModifiers(Modifier.PUBLIC)
//                                        .addField(ClassName.get("com.liby.autoinit",groupFile),"init",Modifier.FINAL,Modifier.PRIVATE)
//                                        // .addMethod(loadIntoMethodOfGroupBuilder.build())
//                                        .build()
//                        ).build();
                        GenneratorHelper.getGeneratorJavaFile(simpleName,packageName).writeTo(mFiler);
                    }
                } else {
